    ...
    return (
      <ul className={cls} id="header-navs">
        <li
          ...
          className={`${cls}--item`}
        >
          <Link aria-label="Home" className={`LinkButton ${cls}--link`} to="/">
            Home
          </Link>
        </li>
        <li
    ...
    return (
      <div className="header">
        <div id="joinUsMessage" className="showJoinMessage">
          Sorry, Registrations has been Closed... Subscribe to get upcoming
          updates
        </div>
        ...
        <div id="nav-background">
          <div className="nav-mob">{this.renderList("header_nav_mob")}</div>
        </div>
