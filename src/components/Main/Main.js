...
class Main extends Component {
  ...
  onSubmitEmail = e => {
    ...
    if (this.validateEmail(email)) {
      ...
      axios
        .post("https://pure-citadel-50491.herokuapp.com/subscribe/user", {
          email: email
        })
    ...
    return (
      <section className="main">
        ...
        <div className="main_heading">
          <div className="main_heading--primary">Entrepreneurship</div>
        ...
        <div className="main_subscribe">
          <form onSubmit={this.onSubmitEmail}>
            ...
            >
              ...
              <img src={unchecked} alt="error" id="errorSubscribe" />
              <div id="backgroundButton" />
            </button>
          </form>
          <p className="main_subscribe--note">
            <span>Missed eSummit or Internship Fair ?? </span>Now Join our
            Newsletter and never missed any upcoming Updates.
          </p>
        </div>
        <SVG />
      </section>
